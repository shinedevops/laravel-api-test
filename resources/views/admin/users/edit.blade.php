						...
						<div class="col-md-12">
                            <div class="card">
                                <div class="card-body pt-2 pb-3 manageClinicSection">
									<form action="{{route('user.update')}}" method="post" class="user" name="edit_user_form" enctype="multipart/form-data">
										@csrf				
											...
											<div class="row">
												<div class="col-lg-4 col-md-6 col-12">
													<div class="form-group">
														...
														<input type="text" name="email" id="email" value="{{old('email', $record->email)}}" class="form-control form-control-user" />
														@if ($errors->has('email'))
